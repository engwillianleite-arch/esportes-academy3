-- =============================================================================
-- FASE 1 + AUDITORIA: Todas as regras em um único script
-- Aplicar no Supabase: Dashboard → seu projeto → SQL Editor → New query → colar e Run
